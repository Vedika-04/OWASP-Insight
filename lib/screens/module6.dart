            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  simpleResourceLink('OWASP Vulnerable Components Labs'),
                  simpleResourceLink('Snyk - Scan for Vulnerabilities'),
                  const SizedBox(height: 16),
                  sectionTitle('Watch & Learn:'),
                  simpleResourceLink('Watch: Understanding Vulnerable Components (YouTube)'),
                ],
              ),
            ),
          ],
